...
export const siteConfig: SiteConfig = {
	title: "JustDreemurr's Blog",
	subtitle: "",
	siteURL: "https://blog.fallenstars.me/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-12-21", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	font: {
		...
		cjkFont: {
			// 中日韩字体 - 作为回退字体
			fontFamily: "江城圆体 500W",
			fontWeight: "500",
			localFonts: ["江城圆体 500W.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: false, // 启用看板娘
	models: ["/pio/models/Sherry/Sherry - Model.model3.json"], // 默认模型路径
